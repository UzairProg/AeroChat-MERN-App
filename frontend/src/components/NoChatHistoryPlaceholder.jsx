...
const NoChatHistoryPlaceholder = ({ name }) => {
  return (
    <div className="flex flex-col items-center justify-center py-[20%] text-center p-6 overflow-hidden">
      ...
      <h3 className="text-lg font-medium text-slate-200 mb-3 ">
        Start your conversation with <span className="text-cyan-400 capitalize">{name}</span>
      </h3>
